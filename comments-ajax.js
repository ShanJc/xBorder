...
var edit_mode = '1', // 再編輯模式 ( '1'=開; '0'=不開 )
		...
		pic_sb = wp_url + 'wp-content/themes/xBorder/images/ajaxloading.gif', // 提交 icon
		pic_no = wp_url + 'wp-content/themes/xBorder/images/error.png',      // 錯誤 icon
		pic_ys = wp_url + 'wp-content/themes/xBorder/images/yes.png',     // 成功 icon
		txt1 = '<div id="loading"><img src="' + pic_sb + '" style="vertical-align:middle;" alt=""/> 正在提交, 请稍候...</div>',
		txt2 = '<div id="loading"><div id="error">#</div></div>',
