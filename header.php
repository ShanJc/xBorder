...
<header>  
  ...
  <div class="header-inner">
    ...
    <form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" >
			<input class="search-input" name="s" type="text" placeholder="官人我要~"<?php if( is_search() ){ echo ' value="'.$s.'"'; } ?> ><input class="search-submit" type="submit" value="Search">
		</form>
...
<!--loding progress bar-->
<div id="loadbar" style="display: none;"><div style="width: 0%; display: block;"></div></div>
<script type="text/javascript">
		$("#loadbar").show();
		$("#loadbar div").animate({width:"20%"});
</script>